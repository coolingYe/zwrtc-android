...
public class WebRtcAudioEffects {
  ...
  public static boolean isAcousticEchoCancelerBlacklisted() {
    List<String> blackListedModels = org.webrtc.voiceengine.WebRtcAudioUtils.getBlackListedModelsForAecUsage();
  ...
  public static boolean isNoiseSuppressorBlacklisted() {
    List<String> blackListedModels = org.webrtc.voiceengine.WebRtcAudioUtils.getBlackListedModelsForNsUsage();
    boolean isBlacklisted = blackListedModels.contains(Build.MODEL);
    if (isBlacklisted) {
  ...
  public static boolean canUseAcousticEchoCanceler() {
    boolean canUseAcousticEchoCanceler = isAcousticEchoCancelerSupported()
        && !org.webrtc.voiceengine.WebRtcAudioUtils.useWebRtcBasedAcousticEchoCanceler()
  ...
  public static boolean canUseNoiseSuppressor() {
    boolean canUseNoiseSuppressor = isNoiseSuppressorSupported()
        && !org.webrtc.voiceengine.WebRtcAudioUtils.useWebRtcBasedNoiseSuppressor() && !isNoiseSuppressorBlacklisted()
